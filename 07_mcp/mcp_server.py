...
@mcp.prompt(
    name = "summarize",
    description = "Summarizes the contents of a document in a concise paragraph."
)
def summarize_doc(
    ...
    Please read the document using the 'read_doc_contents' tool and then provide a clear,
    concise summary in a single paragraph covering the key points.
    """
